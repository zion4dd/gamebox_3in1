...
@REM # change DEV variable in app.py to False
@REM DEV = False

@REM # run this file in terminal to build app.exe:
@REM ./build

pyinstaller -w -F -i icon.ico --add-data "./venv/Lib/site-packages/customtkinter;customtkinter/" --add-data "icon.ico;." app.py
